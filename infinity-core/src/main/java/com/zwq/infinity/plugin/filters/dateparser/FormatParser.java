...
//		DateTimeFormatter fmt = DateTimeFormat.forPattern("d MMM, yyyy").withLocale(Locale.ENGLISH);
//		String str = date.toString(fmt);
//
//		long a = DateTimeFormat.forPattern("dd MMM YYYY:HH:mm:ss").withLocale(Locale.ENGLISH).parseMillis("13 May 2015:22:46:59");
//
//		DateTime b = DateTimeFormat.forPattern("dd MMM YYYY:HH:mm:ss").withLocale(Locale.forLanguageTag("en")).parseDateTime("13 May 2015:22:46:59");
//
//
